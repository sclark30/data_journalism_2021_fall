...
**Answer** A dataframe with politician's covid tweets.
...
**Answer** It doesn't combine and filter out small differences in capitalization/punctuation which would make the list of words smaller and condensed.
...
**Answer** It pulled out a bunch of words from the covid tweets that don't really mean anything and are primarily articles.
...
**Answer** Somewhat, in that it gives us more of a trend/pattern of common words.
...
**Answer** In 2020 and 2021, both patterns are focused on COVID, but in 2020 it is more focused on relief and solving a crisis versus in 2021 there is a focus on vaccines.
...
**Task** Run the following code and describe the results.
**Answer** A dataframe showing the top ten bigrams in tweets for 2020.
...
**Task** Run the following code and describe the results.
**Answer** A dataframe showing the top ten bigrams in tweets for 2021.
...
**Task** Run the following code and describe the results.
**Answer** A dataframe showing the top ten bigrams for democrats and republicans.
...
**Task** Run the following code and describe the results.
**Answer** A dataframe showing the top ten bigrams for republican house candidates in 2020 and 2021.
...
**Answer** A dataframe showing words and their projected sentiment. Trump is marked as positive - which it might be thinking of the actual word Trump instead of the person so that sentiment could swing both ways.
