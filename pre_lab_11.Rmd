...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output shows hospitals in Maryland with general acute care centers.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output shows a scatterplot with hopsitals in Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output just loads a package called tigris.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output shows a table with GEOID numbers, state and county FP and more specific details about the counties.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output does not show anything until the following question.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output shows a map of Maryland with counties outlined.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**It shows data points throughout Maryland with each point representing a hospital. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now the plots are color-coded by the amoutn of beds in each hopsital.
...
**Answer** Loads the tidycensus library.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Shows a dataset with hopsitals in Maryland that have a general acute care center.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A table that shows hospital beds per county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A table showing the population estimate per county in MD.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A table showing population estimate per county along with GEOID code by each county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** table showing number of beds per MD county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A cleaned table showing only MD counties with population and their geometry. Also shows the top ten of those.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Dataframe has been joined with md_beds and md_county_pop to display the frame below.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** New dataframe with the counties above zeroed out.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Dataframe measuring beds per county with the highest beds per county at the top.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Maryland map with coloring that calculates beds per county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Same map as above but with a better color scheme to identify data.
...
**Answer** In the lower part of Maryland, most counties have around 110 beds per 100k, only one county has around 404 per 100k.
