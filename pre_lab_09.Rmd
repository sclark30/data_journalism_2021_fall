...
**Answer** Line 56 is reading in the Maryland PPP into a dataframe called top Maryland PPP counties. Group by is sorting the information by the project county name. Summarise is counting the total loans per project county name, and then arrange is putting the highest loans at the top. Head is showing only the first 10 counties in the dataframe. Line 64 is just showing the dataframe again after the code has been completed.
...
**Answer** It has made a blank gray box for our chart.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** I see a bar chart for the top ten counties data that we found earlier.
...
**Answer** The county data is now reordered from lowest to highest
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The county names are flipped onto the Y axis to provide a better visualization.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The background color of the chart has changed.
...
**Answer** The economist theme haws been applied to the chart, making the background blue and the wording a little more bold.
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The header on the chart is now in bold and there is source information.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Now the dataframe dates are showing in a line chart the number of loans approved per date.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The graph shows the dates with the highest amount of loans and lowest. It shows what the average amount of loans approved looks like per day.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The specific dates for loan approval are displayed on the x axis.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Now the date labels on the x-axis are displayed at an angle making them easier to read.
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
