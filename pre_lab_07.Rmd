...
**Answer** The web page appers to be a bunch of NAICS code tables, along with descriptions about the classification of those codes.
...
**Answer** It looks like a bunch of containers with pretty similar information within them. They use pretty similar coding throughout the containers, primarily starting with href=. 
...
**Answer** It gives an overview again of the industry classifications. 
...
**Answer** The naics_industry value appers to show the head and body tags in the source code.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** After right-clicking, it pops up the source code information that involves the word "sector." 
...
**Answer** The survey abbreviation, seasonal adjustment code, industry and data type code all appear in a small table below. 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** Values showing the number of rows and columns in each table appear. 
...
**Answer** The drop down then shows for the first table the conversion, reference and data month, and for the following shows more specfics about those tables as well. 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**In row two it shows the sector and dsecription.
...
**Answer** The table then just shows the sector and the specific description of what that sector is for the data we are seeking.
...
**Answer**After cleaning, the data all appears on one page because we got rid of one of the rows. 
...
**Answer** The same table with the sector description that we scraped for in the last section appears. 
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**This page shows workplace stats.
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer**The source code with the employee table information and code pops up.
...
**Answer** It narrows down the source code to just the employment information we want. 
...
**Answer** It converts that source code into a table we can use.
...
**Answer** The code just shows the number of employees. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** It shows industry info for mining, quarrying and oil and gas. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** It shows specific industry info for construction. 
...
**Answer** The ten industries we want to gather information from are now picked out and produced below. 
```{r}
...
**Answer** It creates a value of list_of_sectors in our environment. 
```{r}
...
**Answer** From there it creates a list of the ten sectors we want information from. 
```{r}
...
**Answer** A list of our sectors appears in code. 
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** An industry list appears. 
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** An error appears for no object "sector_name" can be found. 
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer** A list now appears that replaces the industry names with numbers.
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Answer** A table now appears that we can use to better read the data.
...
**Answer**An output of 20 rows appears.
...
**Answer** A list stating the number of rows in the dataframe appears.
...
**Answer** The same empployment data from earlier appears again.
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer** A table with the sector and description information appears.
```{r}
# Define url of page we want to scrape
...
**Answer** The information that is in all 3 urls appears in a table below.
...
**Answer** The same table above appears, but now the xpath id is added to it. 
...
**Answer** The same table appears, without the public admin sector in it.
...
**Answer** A table showing the other services sector appears, but does not include public administration.
...
**Answer** Source code for the row number, url and xpath appears. 
```{r}
...
**Answer** A table showing the data series, back data and months appears. 
...
**Answer** A single row showing just the employees and their back data for each month appears. 
...
**Answer** The same row appears, but now the sector and description for that employee info has been added.
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer** A row showing just the sector, description and the June 2021 employees is produced. 
...
**Answer** Now a table with the sector description and june 2021 employees info is shown for all ten industries. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** A table for employment and unemployment rates over the past few months of 2021 appears. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** A table with a single row just showing unemployment rates in 2021 appears. 
...
**Answer** A table appears showing the sector, description and June 2021 employees without the agriculture sector. 
