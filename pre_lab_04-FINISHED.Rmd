...
**Answer** Yes, they all have chr, dbl for the column structure and they also happen to each only have 9 columns. 
...
**Answer** Can't join because of incompatible types. The zip types are not the same, so we need to mutaute one of them to be the same.
...
**Answer**No, many of the rows are now showing as NA.
...
**Answer**Yes, except for franchise name and non-profit. 
...
**Answer** Average amount - 53836.46 and median amount 20000
...
**Answer** Average amount - 88140.24 and median amount - 20833
...
**Answer** Rural average amount - 44328.87 and median amount- 19621. Urban average amount- 53868.53 and median amount - 20000.
...
**Answer** Rural average amount - 73694.14 and median amount - 20833. Urban average amount - 90911.14 and median amount - 20833.
